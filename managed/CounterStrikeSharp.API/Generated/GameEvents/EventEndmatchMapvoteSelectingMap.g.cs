...
public class EventEndmatchMapvoteSelectingMap : GameEvent
{
    ...
    public virtual int Slot1
    {
        get => Get<int>("slot1");
        set => Set<int>("slot1", value);
    }

    public virtual int Slot10
    {
        get => Get<int>("slot10");
        set => Set<int>("slot10", value);
    }

    public virtual int Slot2
    {
        get => Get<int>("slot2");
        set => Set<int>("slot2", value);
    }

    public virtual int Slot3
    {
        get => Get<int>("slot3");
        set => Set<int>("slot3", value);
    }

    public virtual int Slot4
    {
        get => Get<int>("slot4");
        set => Set<int>("slot4", value);
    }

    public virtual int Slot5
    {
        get => Get<int>("slot5");
        set => Set<int>("slot5", value);
    }

    public virtual int Slot6
    {
        get => Get<int>("slot6");
        set => Set<int>("slot6", value);
    }

    public virtual int Slot7
    {
        get => Get<int>("slot7");
        set => Set<int>("slot7", value);
    }

    public virtual int Slot8
    {
        get => Get<int>("slot8");
        set => Set<int>("slot8", value);
    }

    public virtual int Slot9
    {
        get => Get<int>("slot9");
