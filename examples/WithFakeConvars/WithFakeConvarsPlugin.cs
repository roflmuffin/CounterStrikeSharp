...
public class WithFakeConvarsPlugin : BasePlugin
{
    ...
    public FakeConVar<int> ExampleIntCvar  = new("example_int", "An example integer cvar", 10, new RangeValidator<int>(0, 100));
    
    public FakeConVar<float> ExampleFloatCvar = new("example_float", "An example float cvar", 10, new RangeValidator<float>(5, 20));
    ...
    public FakeConVar<int> ExampleEvenNumberCvar = new("example_even_number", "An example even number cvar", 0, new EvenNumberValidator());
