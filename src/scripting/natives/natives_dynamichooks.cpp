...
void DHookGetRegister(ScriptContext& script_context)
{
    ...
    switch (requestedRegId) {
        case DHookRegister::EAX_RAX: dynoRegType = dyno::RegisterType::RAX; break; 
        case DHookRegister::EBX_RBX: dynoRegType = dyno::RegisterType::RBX; break;
        case DHookRegister::ECX_RCX: dynoRegType = dyno::RegisterType::RCX; break;
        case DHookRegister::EDX_RDX: dynoRegType = dyno::RegisterType::RDX; break;
        case DHookRegister::ESI_RSI: dynoRegType = dyno::RegisterType::RSI; break;
        case DHookRegister::EDI_RDI: dynoRegType = dyno::RegisterType::RDI; break;
        case DHookRegister::EBP_RBP: dynoRegType = dyno::RegisterType::RBP; break;
        case DHookRegister::ESP_RSP: dynoRegType = dyno::RegisterType::RSP; break;
        case DHookRegister::R8:  dynoRegType = dyno::RegisterType::R8;  break;
        case DHookRegister::R9:  dynoRegType = dyno::RegisterType::R9;  break;
        case DHookRegister::R10: dynoRegType = dyno::RegisterType::R10; break;
        case DHookRegister::R11: dynoRegType = dyno::RegisterType::R11; break;
        case DHookRegister::R12: dynoRegType = dyno::RegisterType::R12; break;
        case DHookRegister::R13: dynoRegType = dyno::RegisterType::R13; break;
        case DHookRegister::R14: dynoRegType = dyno::RegisterType::R14; break;
        case DHookRegister::R15: dynoRegType = dyno::RegisterType::R15; break;
        case DHookRegister::XMM0: dynoRegType = dyno::RegisterType::XMM0; break;
        case DHookRegister::XMM1: dynoRegType = dyno::RegisterType::XMM1; break;
        case DHookRegister::XMM2: dynoRegType = dyno::RegisterType::XMM2; break;
        case DHookRegister::XMM3: dynoRegType = dyno::RegisterType::XMM3; break;
        case DHookRegister::XMM4: dynoRegType = dyno::RegisterType::XMM4; break;
        case DHookRegister::XMM5: dynoRegType = dyno::RegisterType::XMM5; break;
        case DHookRegister::XMM6: dynoRegType = dyno::RegisterType::XMM6; break;
        case DHookRegister::XMM7: dynoRegType = dyno::RegisterType::XMM7; break;
        case DHookRegister::XMM8: dynoRegType = dyno::RegisterType::XMM8; break;
        case DHookRegister::XMM9: dynoRegType = dyno::RegisterType::XMM9; break;
        case DHookRegister::XMM10: dynoRegType = dyno::RegisterType::XMM10; break;
        case DHookRegister::XMM11: dynoRegType = dyno::RegisterType::XMM11; break;
        case DHookRegister::XMM12: dynoRegType = dyno::RegisterType::XMM12; break;
        case DHookRegister::XMM13: dynoRegType = dyno::RegisterType::XMM13; break;
        case DHookRegister::XMM14: dynoRegType = dyno::RegisterType::XMM14; break;
        case DHookRegister::XMM15: dynoRegType = dyno::RegisterType::XMM15; break;
        default:
    ...
    if (dataType == DATA_TYPE_M128A_POINTER) {
        ...
        switch (dataType) {
            case DATA_TYPE_BOOL:       script_context.SetResult(static_cast<bool>(regValue)); break;
            case DATA_TYPE_CHAR:       script_context.SetResult(static_cast<char>(regValue)); break;
            case DATA_TYPE_UCHAR:      script_context.SetResult(static_cast<unsigned char>(regValue)); break;
            case DATA_TYPE_SHORT:      script_context.SetResult(static_cast<short>(regValue)); break;
            case DATA_TYPE_USHORT:     script_context.SetResult(static_cast<unsigned short>(regValue)); break;
            case DATA_TYPE_INT:        script_context.SetResult(static_cast<int>(regValue)); break;
            case DATA_TYPE_UINT:       script_context.SetResult(static_cast<unsigned int>(regValue)); break;
            case DATA_TYPE_LONG:       script_context.SetResult(static_cast<long>(regValue)); break;
            case DATA_TYPE_ULONG:      script_context.SetResult(static_cast<unsigned long>(regValue)); break;
            case DATA_TYPE_LONG_LONG:  script_context.SetResult(static_cast<long long>(regValue)); break;
            case DATA_TYPE_ULONG_LONG: script_context.SetResult(static_cast<unsigned long long>(regValue)); break;
            case DATA_TYPE_FLOAT: {
                uint32_t val32 = static_cast<uint32_t>(regValue);
                script_context.SetResult(*reinterpret_cast<float*>(&val32));
                break;
            }
            case DATA_TYPE_STRING:     script_context.SetResult(reinterpret_cast<const char*>(regValue)); break;
            case DATA_TYPE_POINTER:    script_context.SetResult(reinterpret_cast<void*>(regValue)); break;
            default: {
